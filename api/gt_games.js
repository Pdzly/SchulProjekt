...
function getNews() {
    return new Promise(function (res, rej) {
        const options = { "method": "GET", "hostname": "gaming-news.p.rapidapi.com", "port": null, "path": "/news", "headers": { "x-rapidapi-host": "gaming-news.p.rapidapi.com", "x-rapidapi-key": "aaad652c75msh3ecf07b9418e8a2p1c5db6jsn5577a25bb8c1", "useQueryString": true } };
...
router.get('/getgames', function (req, res, next) {
    db.querysimple("spielemaster", null, null).then(data =>{
        res.json([{ success: true, data: data }]);
    }, rej => {
        res.json({fuck: true})
    })
